...
class Test
  ...
  def Test.test_cross_segment_xrefs()
    ...
    assert_hash(result, {
      's1' => {
        :nodes => {
          0x0000 => { :type => 'undefined', :refs => [], :xrefs => [{:address => 0x1000}, {:address => 0x1004}] },
        }
      },
      's2' => {
        :nodes => {
  ...
  def Test.test_data_xrefs()
    ...
    result = workspace.new_node('s1', 0x0000, 'dword0', 4, 'value0', { }, [{:address => 0x1000, :type => "code"}, {:address => 0x1004, :type => "data"}])
    assert_hash(result, {
      's1' => {
        :nodes => {
          0x0000 => { :type => 'dword0', :refs => [{:address => 0x1000, :type => "code"}, {:address => 0x1004, :type => "data"}], :xrefs => [] },
        },
      },
      's2' => {
        :nodes => {
          0x1000 => { :type => 'undefined', :refs => [], :xrefs => [{:segment => 's1', :address => 0x0000, :type => "code"}] },
          0x1004 => { :type => 'undefined', :refs => [], :xrefs => [{:segment => 's1', :address => 0x0000, :type => "data"}] },
        },
      },
    }, 'dataxref7', true)
    ...
    assert_hash(result, {
      ...
      's2' => {
        :nodes => {
          0x1000 => { :type => 'undefined', :refs => [], :xrefs => [] },
          0x1004 => { :type => 'undefined', :refs => [], :xrefs => [] },
        },
      },
    }, 'dataxref8', true)
    ...
    result = workspace.new_node('s1', 0x0000, 'dword0', 4, 'value0', { }, [{:address => 0x1000, :type => "code"}, {:address => 0x1000, :type => "data"}])
    assert_hash(result, {
      's1' => {
        :nodes => {
          0x0000 => { :type => 'dword0', :refs => [{:address => 0x1000, :type => "code"}, {:address => 0x1000, :type => "data"}], :xrefs => [] },
        },
      },
      's2' => {
        :nodes => {
          0x1000 => { :type => 'undefined', :refs => [], :xrefs => [{:segment => 's1', :address => 0x0000, :type => "code"}, {:segment => 's1', :address => 0x0000, :type => "data"}] },
        },
      },
    }, 'dataxref9', true)
